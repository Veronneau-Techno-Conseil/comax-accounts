    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationTypeMaps", x => x.ApplicationId);
                    table.ForeignKey(
                        name: "FK_ApplicationTypeMaps_ApplicationTypes_ApplicationTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    Type = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserApplicationMap", x => x.ApplicationId);
                    table.ForeignKey(
                        name: "FK_UserApplicationMap_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationTypeMaps_ApplicationTypeId",
                table: "ApplicationTypeMaps",
